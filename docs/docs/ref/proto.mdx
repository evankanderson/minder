...
| project | <TypeLink type="string">string</TypeLink> | optional | ID or name of the project. If empty or unset, will select the user's default project if they only have one project. |
...
| identifier_property | <TypeLink type="string">string</TypeLink> |  | identifier_property is a blob that uniquely identifies the entity. This is meant to be interpreted by the provider. |
